...
os.environ['W_HOTBOX_REPO_PATHS'] = f"{W_hotboxCommonPath}default_buttons{os.pathsep}{W_hotboxCommonPath}mgl_buttons"
os.environ['W_HOTBOX_REPO_NAMES'] = f"default_buttons{os.pathsep}mgl_buttons"
